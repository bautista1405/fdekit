...
| `@fdekit/connector-customer-api` | `customerApiConnector()` | `customer.get`, `ticket.get`, `ticket.escalate` | `CustomerApiConnectorConfig`, `CustomerApiConnectorOptions`, `CustomerApiMapper`, `CustomerApiRoutes`, `GetCustomerArgs`, `GetTicketArgs`, `EscalateTicketArgs` |
