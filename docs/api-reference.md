...
| `@fdekit/connector-k6` | `k6Connector()` | `loadtest.run` | `K6ConnectorConfig`, `K6ConnectorMode`, `K6ConnectorOptions`, `K6RunArgs`, `K6RunEvidenceKind`, `K6RunResult`, `K6Scenario`, `K6CommandInvocation`, `K6CommandResult` |
