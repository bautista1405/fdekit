...
export const escalationConnectorManifests: ConnectorManifest[] = [
  {
    ...
    tools: ['slack.message', 'slack.notify'],
    maturity: 'Beta',
  ...
  },
  {
    ...
    tools: ['issue.create', 'github.pr.diff', 'github.review.post', 'github.pr.reply'],
    maturity: 'Beta',
  ...
  },
  {
    ...
    tools: ['jira.issue.create', 'issue.create', 'jira.issue.get', 'jira.issue.comment'],
    maturity: 'Beta',
  ...
  },
  {
    ...
    tools: ['linear.issue.create', 'issue.create', 'linear.issue.get', 'linear.issue.comment'],
    maturity: 'Beta',
    supportNote: 'Supports demo/local mode and API mode for issue creation, plus the shared `issue.create` tool pattern',
