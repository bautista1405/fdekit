...
const cliCommands = [
  ...
  ['fdekit feedback export [--json]', 'Export approval and audit feedback into eval candidates.', 'packages/cli/src/commands/feedback.ts'],
...
function renderCliPage() {
  ...
  return [
    ...
    ...[
      ...
      ['fdekit feedback export [--json]', 'Turn approval and audit decisions into eval candidates.'],
